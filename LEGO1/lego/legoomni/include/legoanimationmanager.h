...
public:
	...
	void EnableCharacterForNames(const LegoChar* p_characterNames[], MxU32 p_numCharacterNames);
	void SetEnableAllCharacters(MxBool p_enabled);
	void SetActive(MxS32 p_objectIds[], MxU32 p_numObjectIds);
	...
	void UnkToggleAnimation(MxBool p_und);
	LegoTranInfo* GetTranInfo(MxU32 p_index);
	void SetTransitionInfo();
	void PurgeExtra(MxBool p_force);
	...
	MxResult SetCharacterDurationAndUnkown10(const char* p_name, MxS32 p_unk0x0c, MxS32 p_unk0x10);
	MxBool IsStateAtLeast6(MxU32 p_objectId);
...
private:
	...
	MxResult CreateTranInfo(MxU32 p_objectId, MxMatrix* p_matrix, MxBool p_und1, MxBool p_und2);
	void DeleteAnimations();
	void FUN_10061530();
	MxResult GetFirstAndLastAnimationIndexForLocation(MxS32 p_location, MxU16& p_firstIndex, MxU16& p_lastIndex);
	MxU16 FUN_10062110(
		LegoROI* p_roi,
		Vector3& p_direction,
		Vector3& p_position,
	...
	MxBool OverlapsBoundingSphere(Mx3DPointFloat& p_position, float p_radius, LegoROI* p_roi);
	...
	MxBool PointOnEdgeVisible(LegoPathBoundary* p_boundary, LegoOrientedEdge* p_edge, float p_destScale);
	...
	void StartCameraAnimation(LegoTranInfo* p_tranInfo, MxLong p_unk0x404);
	...
	MxLong m_cameraAnimationStartTime;                    // 0x434
	MxLong m_cameraAnimationEndTime;                      // 0x438
	MxMatrix m_cameraAnimationStart;                      // 0x43c
	MxMatrix m_cameraAnimationEnd;                        // 0x484
	MxQuaternionTransformer m_cameraAnimationTransformer; // 0x4cc
};
